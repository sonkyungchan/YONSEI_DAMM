...
int32_t homeoffset[] = {1183288,685834,1064152,586632,331032,248261,248592};// for ver1

int first_step[] = {0,2,4};//,6}; //vertical axis {0,2,4,6}
int second_step[] = {1,3,5};  //horizontal axis {1,3,5}

...
def attatch_safety(manipulator1, manipulator2):
        ...
        box_name = "mani1_link2_shield"

        manipulator1.scene.add_box(box_name, box_pose, size=(0.19, 0.2, 0.19))
        manipulator2.scene.add_box(box_name, box_pose, size=(0.19, 0.2, 0.19))
        manipulator1.scene.attach_box("mani1_link2", box_name,
                                      touch_links=["mani1_link2", "mani1_link3", "mani1_link4", "mani1_link5",
                                                   "mani1_link6", "mani1_link7", "mani1_eff"])
        ...
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 1.0
        box_name = "mani1_link3_shield"

        manipulator1.scene.add_box(box_name, box_pose, size=(0.19, 0.26, 0.19))
        manipulator2.scene.add_box(box_name, box_pose, size=(0.19, 0.26, 0.19))
        manipulator1.scene.attach_box("mani1_link3", box_name,
                                      touch_links=["mani1_link2", "mani1_link3", "mani1_link4", "mani1_link5",
                                                   "mani1_link6", "mani1_link7", "mani1_eff"])
        ...
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 1.0
        box_name = "mani1_link4_shield"

        manipulator1.scene.add_box(box_name, box_pose, size=(0.18, 0.18, 0.18))
        manipulator2.scene.add_box(box_name, box_pose, size=(0.18, 0.18, 0.18))
        manipulator1.scene.attach_box("mani1_link4", box_name,
                                      touch_links=["mani1_link2", "mani1_link3", "mani1_link4", "mani1_link5",
                                                   "mani1_link6", "mani1_link7", "mani1_eff"])
        ...
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 1.0
        box_name = "mani1_link5_shield"

        manipulator1.scene.add_box(box_name, box_pose, size=(0.18, 0.23, 0.18))
        manipulator2.scene.add_box(box_name, box_pose, size=(0.18, 0.23, 0.18))
        manipulator1.scene.attach_box("mani1_link5", box_name,
                                      touch_links=["mani1_link2", "mani1_link3", "mani1_link4", "mani1_link5",
                                                   "mani1_link6", "mani1_link7", "mani1_eff"])
        box_pose.header.frame_id = "base_link"
        box_pose.pose.position.x = 0.23
        box_pose.pose.position.y = 0
        box_pose.pose.position.z = 1.13
        box_pose.pose.orientation.x = 0
        box_pose.pose.orientation.y = 0
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 1.0
        box_name = "mani1_link6_shield"

        manipulator1.scene.add_box(box_name, box_pose, size=(0.16, 0.18, 0.16))
        manipulator2.scene.add_box(box_name, box_pose, size=(0.16, 0.18, 0.16))
        manipulator1.scene.attach_box("mani1_link6", box_name,
                                      touch_links=["mani1_link2", "mani1_link3", "mani1_link4", "mani1_link5",
                                                   "mani1_link6", "mani1_link7", "mani1_eff"])
        box_pose.header.frame_id = "base_link"
        box_pose.pose.position.x = 0.23
        box_pose.pose.position.y = 0
        box_pose.pose.position.z = 1.26
        box_pose.pose.orientation.x = 0
        box_pose.pose.orientation.y = 0
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 1.0
        box_name = "mani1_link7_shield"

        manipulator1.scene.add_box(box_name, box_pose, size=(0.16, 0.18, 0.16))
        manipulator2.scene.add_box(box_name, box_pose, size=(0.16, 0.18, 0.16))
        manipulator1.scene.attach_box("mani1_link7", box_name,
                                      touch_links=["mani1_link2", "mani1_link3", "mani1_link4", "mani1_link5",
                                                   "mani1_link6", "mani1_link7", "mani1_eff"])
        box_pose.header.frame_id = "base_link"
        box_pose.pose.position.x = 0.23
        box_pose.pose.position.y = 0
        box_pose.pose.position.z = 1.4
        box_pose.pose.orientation.x = 0
        box_pose.pose.orientation.y = 0
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 1.0
        box_name = "mani1_eff_shield"

        manipulator1.scene.add_box(box_name, box_pose, size=(0.14, 0.17, 0.14))
        manipulator2.scene.add_box(box_name, box_pose, size=(0.14, 0.17, 0.14))
        manipulator1.scene.attach_box("mani1_eff", box_name,
                                      touch_links=["mani1_link2", "mani1_link3", "mani1_link4", "mani1_link5",
                                                   "mani1_link6", "mani1_link7", "mani1_eff"])
        ...
        box_pose.pose.position.x = -0.23
        box_pose.pose.position.y = 0
        box_pose.pose.position.z = 0.41
        box_pose.pose.orientation.x = 0
        box_pose.pose.orientation.y = 0
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 1.0
        box_name = "mani2_link2_shield"

        manipulator1.scene.add_cylinder(box_name, box_pose, radius=0.065, height=0.2)
        manipulator2.scene.add_cylinder(box_name, box_pose, radius=0.065, height=0.2)
        manipulator2.scene.attach_box("mani2_link2", box_name,
                                      touch_links=["mani2_link2", "mani2_link3", "mani2_link4", "mani2_link5",
                                                   "mani2_link6", "mani2_link7", "mani2_link8"])

        box_pose.header.frame_id = "base_link"
        box_pose.pose.position.x = -0.23
        box_pose.pose.position.y = 0
        box_pose.pose.position.z = 0.56
        box_pose.pose.orientation.x = -0.7071
        box_pose.pose.orientation.y = 0
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 0.7071
        box_name = "mani2_link3_shield"

        manipulator1.scene.add_cylinder(box_name, box_pose, radius=0.065, height=0.2)
        manipulator2.scene.add_cylinder(box_name, box_pose, radius=0.065, height=0.2)
        manipulator2.scene.attach_box("mani2_link3", box_name,
                                      touch_links=["mani2_link2", "mani2_link3", "mani2_link4", "mani2_link5",
                                                   "mani2_link6", "mani2_link7", "mani2_link8"])
        ...
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 1.0
        box_name = "mani2_link4_shield"

        manipulator1.scene.add_cylinder(box_name, box_pose, radius=0.065, height=0.2)
        manipulator2.scene.add_cylinder(box_name, box_pose, radius=0.065, height=0.18)
        manipulator2.scene.attach_box("mani2_link4", box_name,
                                      touch_links=["mani2_link2", "mani2_link3", "mani2_link4", "mani2_link5",
                                                   "mani2_link6", "mani2_link7", "mani2_link8"])
        ...
        box_pose.pose.position.x = -0.23
        box_pose.pose.position.y = 0
        box_pose.pose.position.z = 0.86
        box_pose.pose.orientation.x = -0.7071
        box_pose.pose.orientation.y = 0
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 0.7071
        box_name = "mani2_link5_shield"

        manipulator1.scene.add_cylinder(box_name, box_pose, radius=0.065, height=0.2)
        manipulator2.scene.add_cylinder(box_name, box_pose, radius=0.065, height=0.2)
        manipulator2.scene.attach_box("mani2_link5", box_name,
                                      touch_links=["mani2_link2", "mani2_link3", "mani2_link4", "mani2_link5",
                                                   "mani2_link6", "mani2_link7", "mani2_link8"])
        ...
        box_pose.pose.position.x = -0.23
        box_pose.pose.position.y = 0
        box_pose.pose.position.z = 1.1
        box_pose.pose.orientation.x = 0
        box_pose.pose.orientation.y = 0
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 1.0
        box_name = "mani2_link6_shield"

        manipulator1.scene.add_cylinder(box_name, box_pose, radius=0.065, height=0.4)
        manipulator2.scene.add_cylinder(box_name, box_pose, radius=0.065, height=0.4)
        manipulator2.scene.attach_box("mani2_link6", box_name,
                                      touch_links=["mani2_link2", "mani2_link3", "mani2_link4", "mani2_link5",
                                                   "mani2_link6", "mani2_link7", "mani2_link8"])
        ...
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 1.0
        box_name = "mani2_link7_shield"

        manipulator1.scene.add_box(box_name, box_pose, size=(0.13, 0.13, 0.13))
        manipulator2.scene.add_box(box_name, box_pose, size=(0.13, 0.13, 0.13))
        manipulator2.scene.attach_box("mani2_link7", box_name,
                                      touch_links=["mani2_link2", "mani2_link3", "mani2_link4", "mani2_link5",
                                                   "mani2_link6", "mani2_link7", "mani2_link8"])
        ...
        box_pose.pose.position.x = -0.23
        box_pose.pose.position.y = 0
        box_pose.pose.position.z = 1.43
        box_pose.pose.orientation.x = 0
        box_pose.pose.orientation.y = 0
        box_pose.pose.orientation.z = 0
        box_pose.pose.orientation.w = 1.0
        box_name = "mani2_link8_shield"

        manipulator1.scene.add_box(box_name, box_pose, size=(0.16, 0.16, 0.16))
        manipulator2.scene.add_box(box_name, box_pose, size=(0.16, 0.16, 0.16))
        manipulator2.scene.attach_box("mani2_link8", box_name,
                                      touch_links=["mani2_link2", "mani2_link3", "mani2_link4", "mani2_link5",
                                                   "mani2_link6", "mani2_link7", "mani2_link8"])
...
#            manipulator2.plan_cartesian_up()
	    ...
	    rel_dist = [0.0, -711.0, 422.519 + 80.0]
...
#            manipulator2.plan_cartesian_down()
            ...
            # angle = 0
            # ??
            ob1_site = [rel_dist[0] + real_position[0], rel_dist[1] + real_position[1], rel_dist[2], 0.714018, -0.700091, 0.00476336, -0.00529695]
...
#            manipulator2.plan_cartesian_up()
	    ...
	    # ob2
            ...
            ob2_site = [rel_dist[0] + real_position[0], rel_dist[1] + real_position[1], rel_dist[2], 0.714018, -0.700091, 0.00476336, -0.00529695]
